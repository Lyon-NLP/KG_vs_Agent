...
class LLMGenerator:
    ...
    def _generate_prompt(self, context: str, question: str) -> list[dict[str, str]]:
        ...
        prompt = [
            ...
            S'il n'y a pas d'information fournie, répond uniquement si tu connais la réponse à la question et précise que les informations doivent être vérifées.
            Si tu ne sais pas répondre à la question, répond "Je suis désolée mais je n'ai pas la réponse à votre question.".
